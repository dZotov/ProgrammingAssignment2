...
## Uses sub functions set, get, setMatrix and getMatrix for matrix and its inverse
...
## cacheSolve function checks if the stored invMatrix is a NULL and calculates inverse if NULL.
